...
public class BlockRegistry {
    ...
    public static final DeferredHolder<Block, GrowerBlock> COPPER_GROWER_BLOCK = BLOCKS.register(
            "copper_grower", () -> new GrowerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK), Config.GROWTH_INTERVAL_COPPER.get(), 4, Config.GROWTH_CHANCE_COPPER.get()));

    public static final DeferredHolder<Block, GrowerBlock> IRON_GROWER_BLOCK = BLOCKS.register(
            "iron_grower", () -> new GrowerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK), Config.GROWTH_INTERVAL_IRON.get(), 4, Config.GROWTH_CHANCE_IRON.get()));

    public static final DeferredHolder<Block, GrowerBlock> GOLD_GROWER_BLOCK = BLOCKS.register(
            "gold_grower", () -> new GrowerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK), Config.GROWTH_INTERVAL_GOLD.get(), 4, Config.GROWTH_CHANCE_GOLD.get()));

    public static final DeferredHolder<Block, GrowerBlock> DIAMOND_GROWER_BLOCK = BLOCKS.register(
            "diamond_grower", () -> new GrowerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK), Config.GROWTH_INTERVAL_DIAMOND.get(), 4, Config.GROWTH_CHANCE_DIAMOND.get()));

    public static final DeferredHolder<Block, GrowerBlock> NETHERITE_GROWER_BLOCK = BLOCKS.register(
            "netherite_grower", () -> new GrowerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHERITE_BLOCK), Config.GROWTH_INTERVAL_NETHERITE.get(), 4, Config.GROWTH_CHANCE_NETHERITE.get()));
